  			...
  			<div class="row mt-5">
  				@foreach($items as $item)
		  			<div class="col-sm-6 col-lg-4 mb-5">
		  				<img src="{{ Storage::url('assets/gallery/photos/'.$item->image) }}" class="img-thumbnail" alt="image">
		  			</div>
	  			@endforeach
	  		</div>
...
@push('addon-script')
	<!-- Custom JS -->
    <script>
    	const allCollectionsImg = document.querySelectorAll('.section-all-collections .img-thumbnail');

    	allCollectionsImg.forEach((img, i) => {
